    ...
    <main className="flex min-h-screen flex-col items-center justify-around">
      ...
      <section className='flex flex-col justify-center items-center w-full'>
        <table className='table-auto border-separate border-spacing-x-60 border-spacing-y-2 border text-center p-2 border-green-400 border-solid rounded-sm'>
          ...
          <tr>
            <td><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="30" viewBox="0 0 48 48">
...
<path fill="#c8e6c9" d="M44,24c0,11.045-8.955,20-20,20S4,35.045,4,24S12.955,4,24,4S44,12.955,44,24z"></path><path fill="#4caf50" d="M34.586,14.586l-13.57,13.586l-5.602-5.586l-2.828,2.828l8.434,8.414l16.395-16.414L34.586,14.586z"></path>
          ...
          {/* Buttons */}
          <tr>
            <td><button className='w-[80px] p-2 border border-green-400 bg-gray-900 hover:border-gray-900 hover:bg-green-400 hover:text-black' >Buy</button></td>
            <td><button className='w-[80px] p-2 bg-green-400 border border-gray-800 text-black hover:border-green-400 hover:bg-gray-900 hover:text-white'>Buy</button></td>
            <td><button className='w-[80px] p-2 border border-green-400 bg-gray-900 hover:border-gray-900 hover:bg-green-400 hover:text-black'>Buy</button></td>
          </tr>
        </table>
      </section>
      ...
      <section className='flex flex-col justify-center items-center h-[20rem] w-full'>
        ...
        <div className='flex gap-6 bg-green-400 rounded-md w-[80rem] max-w-[80rem] p-4 text-black'>
          <div>
